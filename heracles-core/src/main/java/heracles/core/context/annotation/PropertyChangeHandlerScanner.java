package heracles.core.context.annotation;
 ...
 *
 */
public class PropertyChangeHandlerScanner {
	...
	public final Collection<Class<?>> scan(String basePackages) {
		...
		String[] basePackageArray = StringUtils.tokenizeToStringArray(basePackages, ConfigurableApplicationContext.CONFIG_LOCATION_DELIMITERS);
