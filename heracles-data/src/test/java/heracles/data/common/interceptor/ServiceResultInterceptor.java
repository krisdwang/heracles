 ...
 */
public class ServiceResultInterceptor implements MethodInterceptor {

	private static final Logger logger = LoggerFactory.getLogger(ServiceResultInterceptor.class);

	/**
	 * Create a new BindingResultInterceptor.
	 */
	public ServiceResultInterceptor() {
	}
