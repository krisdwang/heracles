...
@ContextConfiguration(locations = { "classpath:cache/applicationContext-cache-test3.xml" }, inheritLocations = true)
public class HeraclesCacheGlobalConfigTest {
	...
	public void testHeraclesCacheGlobalConfig() {
		final String key1 = "3001";
		final String value1 = "tomhanks";
		final String key2 = "3002";
		...
		// System.out.println(orderCache.get(key1).get());
