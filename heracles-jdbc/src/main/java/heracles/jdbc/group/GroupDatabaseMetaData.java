...
import heracles.jdbc.group.exception.GroupException;
...
public class GroupDatabaseMetaData implements DatabaseMetaData {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(GroupDatabaseMetaData.class);

	private DatabaseMetaData databaseMetaData;

	public GroupDatabaseMetaData(DataSource dataSource) throws SQLException {
		Connection conn = null;
		try {
			conn = DataSourceUtils.getConnection(dataSource);
			this.databaseMetaData = conn.getMetaData();
		} catch (SQLException e) {
			LOGGER.error("GroupDatabaseMetaData : init GroupDatabaseMetaData error : " + e.getMessage());
